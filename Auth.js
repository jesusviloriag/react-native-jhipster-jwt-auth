    ...
    static login(username, password) {
        ...
        return fetch(direccion + "authenticate", {
            ...
            .then((responseJson) => {
                ...
                _this.session =  new AuthSession();
                _this.session.token = responseJson.id_token;
                ...
                return fetch(direccion + 'account',{
                    ...
                    .then((responseJson) => {
                        ...
                        if((responseJson)&&(responseJson.login)){
                            AsyncStorage.setItem('@userstore:user',responseJson.login + '');
                            AsyncStorage.setItem('@userstore:token',Auth.session.token);
                            Auth.session.user = responseJson;
                            Auth.session.userEdited = true;
                            return responseJson;
                        }else{
                            return false;
                        }
